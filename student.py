...
class Student:
    def __init__(self,root):
        ...
        #Third Image
        img_left=Image.open(r"images/image13.png")
        ...
        img_right=Image.open(r"images/image13.png")
        ...
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.va_std_id.get()=="":
            ...
            try:
                ...
                if Update>0:
                    conn=mysql.connector.connect(host="localhost",username="root",password="Satara@123",database="face")
                    my_cursor=conn.cursor()
                    my_cursor.execute("update student set Department=%s,Course=%s,Year=%s,Semester=%s,Name=%s,Division=%s,Rollno=%s,Gender=%s,DOB=%s,Email=%s,Phone=%s,Address=%s,teacher=%s,PhotoSampleStatus=%s where StudentId=%s",(
    ...
    def delete_data(self):
        if self.va_std_id.get=="":
            ...
            try:
                delete=messagebox.askyesno("Student Delete page","Do you want to delete this student0",parent=self.root)
                if delete>0:
                    conn=mysql.connector.connect(host="localhost",username="root",password="Satara@123",database="face")
                    my_cursor=conn.cursor()
    ...
    def generate_dataset(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.va_std_id.get()=="":
            ...
            try:
                ...
                face_classifier=cv2.CascadeClassifier(r"C:/Users/Abhishek/Desktop/Smart/haarcascade_frontalface_default.xml")
