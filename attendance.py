...
class Attendance:
    def __init__(self,root):
        ...
        #First Image
        img=Image.open(r"images/image19.jpg")
        ...
        #second Image
        img1=Image.open(r"images/image18.jpg")
        ...
        bg_img.place(x=0,y=180,width=1530,height=650)
        ...
        main_frame.place(x=5,y=55,width=1500,height=550)

        #left label frame
        Left_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student Attendance Details",font=("times new roman",12,"bold"))
        Left_frame.place(x=10,y=10,width=760,height=530)

        img_left=Image.open(r"images/image21.jpg")
        ...
        #Roll no
        roll_label=Label(left_inside_frame,text="Rollno:",font=("times new roman",12,"bold"),bg="white")
        ...
        #Attendance
        attendance_Label=Label(left_inside_frame,text="Attendance Status",bg="white",font="cosmicsansns 11 bold")
        attendance_Label.grid(row=3,column=0)

        self.atten_status=ttk.Combobox(left_inside_frame,width=18,textvariable=self.var_atten_attendance,font="cosmicsansns 11 bold",state="readonly")
        ...
        Right_frame.place(x=780,y=10,width=710,height=530)

        table_frame=Frame(Right_frame,bd=2,relief=RIDGE,bg="white")
        table_frame.place(x=5,y=5,width=690,height=490)

        #==================scroll bar table==================================
        scroll_x=ttk.Scrollbar(table_frame,orient=HORIZONTAL)
        scroll_y=ttk.Scrollbar(table_frame,orient=VERTICAL)

        self.AttendanceReportTable=ttk.Treeview(table_frame,columns=("StudentId","Roll","name","Dep","time","date","attendance"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
        ...
        self.AttendanceReportTable.heading("StudentId",text="Attendance ID")
